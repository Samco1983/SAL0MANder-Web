...
export const GIFT_SURVEY_IDEAS = {
  color: {
    icon: '🎨',
    shortLabel: 'Color',
    extra: ['Teal', 'Gold', 'Pink', 'Orange', 'Yellow', 'Black', 'Lavender', 'Turquoise'],
  },
  'ice-cream': {
    icon: '🍦',
  ...
  animal: {
    icon: '🐾',
    shortLabel: 'Animal',
    extra: ['Fox', 'Otter', 'Pug', 'Dachshund', 'Rabbit', 'Horse', 'Elephant', 'Penguin'],
  },
  ...
  music: {
    icon: '🎵',
    shortLabel: 'Music',
    extra: ['R&B', 'Hip-hop', 'Country', 'Latin', 'Reggae', 'Electronic', 'Indie', 'Soul'],
  },
  weekend: {
    icon: '🌻',
