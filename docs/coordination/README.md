...
Nine files. Everything older is in `archive/` for history, and nothing new
...
| **`ADVISORY-PROTOCOL.md`** | Proposed rules for ChatGPT and any advisory voice. Not yet accepted. | Claude |
| **`ARCHITECTURE-REVIEW-2026-08-18.md`** | **Current architecture of record.** Read before building any automation. | Claude |
