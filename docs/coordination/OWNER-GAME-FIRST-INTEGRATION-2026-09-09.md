...
5. Integrate Slide & Solve (the row/column picture puzzle) from the current Unity draft into the game as a real selectable mode after it clears regression/runtime checks; do not leave it isolated indefinitely.
